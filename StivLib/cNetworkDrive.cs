...
namespace stiv
{
    ...
    public class cNetworkDrive
    {
        ...
        /// <summary>
        /// Option to prompt for user credentials when mapping a drive
        /// </summary>
        ...
        /// </summary>
        /// <param name="username">Username passed for permissions / credentials ('Username' may be passed as null, to map using only a password)</param>
        /// <param name="password">Password passed for permissions / credentials</param>
        ...
        /// Set common propertys, then map the network drive
        /// </summary>
        /// <param name="localDrive">Password passed for permissions / credentials</param>
        /// <param name="force">Option to force dis/connection</param>
